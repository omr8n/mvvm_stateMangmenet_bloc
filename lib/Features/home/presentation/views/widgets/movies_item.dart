...
import 'package:mvvm_statemangments_cubit/Features/home/presentation/views/movie_details_view.dart';
...
class MoviesItem extends StatelessWidget {
  const MoviesItem({super.key, required this.movieModel});
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 10),
                        GenresListView(movieModel: movieModel),
                        Row(
